...
<body style="background-image: url('../../images/back.jpg');">
	<div class="main">
		...
		<%
			...
			String[] tempString = (String[]) session.getAttribute("redirect" + redirected);
			if (redirected != null) {
		...
		<script>
			...
			document.forms["signup-form"]["<%=tempString[3]%>"].checked = true;
		...
		<%
			...
			if (sub != null) {
				...
				String nifS = request.getParameter("nif");
				...
				if (filePath.isEmpty()) {
					...
					response.sendRedirect("Admin_Utente.jsp");
				} else {
					...
					if (redirected != null) {
						...
						admin.createUtente(nif, sexo, idade, nome, apelido, morada, is);
						response.sendRedirect("Admin_Utente.jsp");
					}
				}
			}
